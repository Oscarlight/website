...
# Orignal Sentence:
disList.append("<strong>Baselines:</strong> \n")
...
perScoreList = []
disList.append("<strong>Permutation of derived sentences are:</strong> \n")
...
addScoreList = []
disList.append("<strong>Derived sentences with one wild card are:</strong> \n")
disList.append("Possible candidate" + " --> "+ "Score" + "\n")
...
delScoreList = []
disList.append("<strong>Derived sentences with bei deleted are:</strong> \n")
disList.append("Possible candidate" + " --> "+ "Score" + "\n")
...
disList.append("<strong>God Help me!!</strong> \n")
