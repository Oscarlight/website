...
''' if not doing literal search i.e. "...", it seems google won't block '''
...
saveList2FileNum("/home/oscar/Documents/AptanaStudio3Workspace/searchREMOTERUN/length.txt", lengthList)
saveList2FileNoQ("/home/oscar/Documents/AptanaStudio3Workspace/searchREMOTERUN/sent.txt", totalList)
